        ...
        switch (item.getItemId()) {
            ...
            case R.id.wandm_AddNew:
                Toast.makeText(this, "Add selected!!!", Toast.LENGTH_SHORT)
                        .show();
                break;
            // action with ID wandm_Edit was selected
...
//                break;
    ...
    EditText inputUnit;
    private ArrayList<HashMap<String, String>> w_and_mArrayHashList;
...
//                    theIntent.putExtra("amount2", amount2);
        ...
        W_and_MListAdapter lvWandMAdapter = new W_and_MListAdapter(this, w_and_mArrayHashList);
...
//
//        Log.i("W_and_M_Manage 142:", requestCode + "  resultCode =" + resultCode);
//        if (requestCode == 100) {
...
//
//            }else {
//                Log.i("W_and_M_Manage 150: ", " resultCode ="+resultCode);
//            }
//        }
//    }//onActivityResult
